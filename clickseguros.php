...
class Seguros{
    ...
    public function solicitud_select(){
        $ProcesosBD = new ProcesosBD(self::SERVER,self::USER,self::PWD,self::DB);
        $jsonSolicitud = new jsonSolicitud();

        $consultaSolicitud = "SELECT * FROM solicitud ORDER BY id DESC";
        $consultaGastosMedicos = "SELECT * FROM solicitudsegurogastosmedicos ORDER BY idSolicitud";
        $consultaVehiculos = "SELECT * FROM solicitudsegurovehiculo ORDER BY idSolicitud";
        $consultaVidaAhorro = "SELECT * FROM solicitudsegurovidaahorro ORDER BY idSolicitud";
        
        $jsonSolicitud->sDatos = $ProcesosBD->tabla($consultaSolicitud);
        $jsonSolicitud->sGastosMedicos = $ProcesosBD->tabla($consultaGastosMedicos);
        $jsonSolicitud->sVehiculos = $ProcesosBD->tabla($consultaVehiculos);
        $jsonSolicitud->sVidaAhorro = $ProcesosBD->tabla($consultaVidaAhorro);
        return json_encode($jsonSolicitud);
    }
}